...
e = process.argv[2]
if (e == "success") {
    if (existsSync("/tmp/apidata_iumessage")) {
        var apidata_iumessage = readFileSync('/tmp/apidata_iumessage', 'utf8');
        var apidata_iutable = readFileSync('/tmp/apidata_iutable', 'utf8');
...
var err = readFileSync('/tmp/apidata_err', 'utf8');
